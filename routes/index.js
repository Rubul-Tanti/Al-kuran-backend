...
const { createJob, deleteJob, updateJob, fetchPost, fetchMyPosts }=require("../controlers/job")
...
router.post("/teacherlist",asyncError(teacherList))
...
router.get("/fetchjobs",asyncError(fetchPost))
